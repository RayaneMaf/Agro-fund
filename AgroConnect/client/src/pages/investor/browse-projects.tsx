...
// //   const { data: projects = [], isLoading } = useQuery<ProjectPost[]>({
// //     queryKey: ["/api/projects"],
// //   });

// //   const { data: myApplications = [] } = useQuery<{ project_id: number }[]>({
...
// //       return apiRequest("POST", "/api/applications/project", {
...
// //       });
// //       queryClient.invalidateQueries({ queryKey: ["/api/investors", user?.id, "applications"] });
...
// //       if (riskFilter !== "all") {
// //         const score = project.ai_risk_score ?? 50;
...
// //     searchQuery || zoneFilter !== "all" || statusFilter !== "all" || riskFilter !== "all";
...
// //                       <SelectItem value="medium">Medium Risk (35-65%)</SelectItem>
...
//       if (riskFilter !== "all") {
//         // Use risk_score from backend (not ai_risk_score)
//         const score = project.ai_risk_score ?? project.ai_risk_score ?? 50;
//         if (riskFilter === "low" && score >= 35) return false;
